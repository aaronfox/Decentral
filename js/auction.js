...
function getProfiles() {
  $.each(profiles, function(index, profile) {
    $(".profiles").append("<div class=\"profile\"><div class=\"profile-name\">" + profile.name + "</div><div class=\"principal\">$" + profile.principal.toFixed(2) + "</div><div class=\"interest\">" + profile.interest  + "%</div><div class=\"numberOfMonths\">" + profile.numberOfMonths + "</div></div>");
  });
}
